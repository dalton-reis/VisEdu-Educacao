...
public class NumExpSintatico implements Constants
{
    private Stack stack = new Stack();
    private Token currentToken;
    private Token previousToken;
    private NumExpLexico scanner;
    private NumExpSemantico semanticAnalyser;

    public void parse(NumExpLexico scanner, NumExpSemantico semanticAnalyser) throws LexicalError, SyntaticError, SemanticError
    {
