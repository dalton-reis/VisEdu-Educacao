var ObjetoFisica = function (_tamanho, _tipo, _material, indicie, _posicoes, _velocidade, _massa, _amortecLinear, _amortecAngular, _rotacao, _aceleraco, _orientacao, _colicaoCom) {
    ...
    this.getDiv = function () {
        ...
        div.innerHTML = "<br> <br> Objeto " + (objeto_ID + 1);
    ...
    this.addLista = function (tipoLista) {
        ...
        sub_div.innerHTML = tipo + " " + (objeto_ID + 1);
