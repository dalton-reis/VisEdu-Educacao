...
var listaObjetosFis = []; //também cria um vetor sem tamnhos.
var listaCorposRigidos = [];

//Variáveis para usar a biblioteca de Fisíca
var simulation;
...
//Evento disparado quando sá da aba.
...
// Carrega a tudo que é preciso para a cena e adciona os listener para o mouse limitando só ao div da cena.
function  inicializa() {

    cena = new THREE.Scene();
    camera = new THREE.PerspectiveCamera(75, window.innerWidth / window.innerHeight, 0.1, 1000);
    //Controles para movimentar a camera
	...
	//Cria a cena apenas dentro do div.
...
case "Esfera":
        ...
        objetoAtual = new ObjetoFisica(parseInt(document.getElementById("Raio").value),
                "Esfera",
...
case "Caixa":
        ...
        objetoAtual = new ObjetoFisica(parseInt(document.getElementById("TamanhoCubo").value),
                "Cubo",
...
case "Alvo":
        {
        try {
        objetoAtual = new ObjetoFisica(parseInt(document.getElementById("TamanhoAlvo").value),
                "Alvo",
                null,
                indice,
                getVector3("posAlvo"),
...
var escrtica;
        ...
        str = "Tamanho: " + objeto.getTamanho() + "<br>  Material: " + objeto.getMaterial() + "<br> Massa: " + objeto.getMassa();
...
;
//Cria um vetor de três posições recebendo como parâmetro o nome do campo.
...
;
//Faz a lista dos objetos com quem com colide, recebendo como parâmetro o tipo do objeto para poder saber de qual lista pegar os dados.
