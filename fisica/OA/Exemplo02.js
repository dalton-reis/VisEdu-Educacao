...
function  inicializa() {
    ...
    simulation.contactListener = function (data) {
        ...
        setTimeout(function () {
            ...
            <p>Agora vamos tentar novamente mas com uma bola de pl&aacute;stico. Clique aqui para disparar. \n\
                <label class="buttonAction" title="Dispara Bola de Pl&aacute;tico" onclick="cannonBall(' + plastico + ')">\n\
...
function iniciaTutorial() {
    document.getElementById('texto_explicacao').innerHTML = document.getElementById('texto_explicacao').innerHTML
            ...
            <label id = "ca" class = "buttonAction" title = "Adiciona Canh&atilde;o" onclick = "createCannon(texto_explicacao)" >\n\
...
<label class="buttonAction" title="Adiciona Alvo" onclick="createTarget()"> \n\
<span class="glyphicon glyphicon-plus-sign " > </span>Alvo.</p>';
}
...
function createTarget() {
    ...
    var teste = "'metal'";
    document.getElementById('texto_explicacao').innerHTML = document.getElementById('texto_explicacao').innerHTML + '<p>Certo agora com o canh&atilde;o e o alvo em cena vamos disparar uma bola de metal e ver o que acontece. Para dispara &eacute; s&oacute; clicar aqui.\n\
<label class="buttonAction" title="Dispara Bola de Metal" onclick="cannonBall(' + teste + ')"> \n\
